...
class Module extends \yii\base\Module
{
     ...
     */
    public $mainLayout = '@contrib/admin/views/layouts/main.php';
    /**
     * @var array
     * @see [[menus]]
     */
    ...
    public function init()
    {
        ...
        if (!isset(Yii::$app->i18n->translations['rbac-admin'])) {
            Yii::$app->i18n->translations['rbac-admin'] = [
                ...
                'sourceLanguage' => 'en',
                'basePath' => '@contrib/admin/messages',
            ];
        }
        ...
        if (class_exists('yii\jui\JuiAsset')) {
            Yii::$container->set('contrib\admin\AutocompleteAsset', 'yii\jui\JuiAsset');
        }
    }
